...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Dr.Robotnik.s.Ring.Racers.zip"
URL_TELECHARGEMENT_KEY=""
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="Dr.Robotnik.s.Ring.Racers.zip"
GAME_FILE_FINAL="Dr. Robotnik's Ring Racers.pc"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Dr. Robotnik's Ring Racers"
GIT_NAME="drrobo"
DESC=""
DEV="Kart Krew"
PUBLISH="Kart Krew"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Dr. Robotnik’s Ring Racers is a technical kart racer inspired by anti-gravity racers, fighting games, and traditional kart racing."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Dr. Robotnik’s Ring Racers” est un Kart Racer technique, dessinant inspiration de “antigrav” coureurs, jeux de combat, et de kart de style traditionnel course."
    LANG="fr"
    INFO_MESSAGE=""
fi
