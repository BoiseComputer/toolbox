...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/spelunky.wsquashfs"
URL_TELECHARGEMENT_KEY=""
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="spelunky.wsquashfs"
GAME_FILE_FINAL="spelunky.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Spelunky is a 2D platformer. You play a spelunker who descends deeper and deeper into a cave. The goal is to finish all the levels and, if possible, maximize your score. The player has several simple moves, including running and jumping."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Spelunky est un jeu de plates-formes en deux dimensions. Le joueur incarne un spéléologue qui descend de plus en plus profondément dans une grotte. Le but du jeu est de finir l'ensemble des niveaux proposés, et éventuellement de maximiser son score. Le joueur a à sa disposition plusieurs mouvements simples. Il peut courir et sauter."
    LANG="fr"
    INFO_MESSAGE=""
fi
