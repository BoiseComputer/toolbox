...
if [ "$LANG_UI" = "en" ]; then
    DESC="Karts. Nitro. Action! SuperTuxKart is a free 3D kart racing game with a large variety of characters, tracks, and game modes. In story mode, you must face the evil Nolok and defeat him to save the mascot kingdom once again! You can race against the computer, or race, battle, or play soccer with up to 8 players locally, on a LAN, or online with players around the world."
    LANG="en"
    INFO_MESSAGE="\n\nUse the WINE-TKG runner to launch!"
else
