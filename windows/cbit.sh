...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/CrashBandicoot-BackInTime.wsquashfs"
URL_TELECHARGEMENT_KEY="https://github.com/foclabroc/toolbox/releases/download/Fichiers/CrashBandicoot-BackInTime.wsquashfs.keys"
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="CrashBandicoot-BackInTime.wsquashfs"
GAME_FILE_FINAL="CrashBandicoot-BackInTime.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Crash Bandicoot BackInTime"
GIT_NAME="crashbit"
DESC=""
DEV="Gembit"
PUBLISH="hucota7"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Crash Bandicoot fan-made game with a custom stage editor."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Crash Bandicoot fanmade avec création de stage personnalisé"
    LANG="fr"
    INFO_MESSAGE=""
fi
