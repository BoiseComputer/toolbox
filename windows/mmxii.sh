...
GAME_NAME="Megaman X Innocent Impulse"
GIT_NAME="mmxii"
DESC=""
DEV="SolrenSun"
PUBLISH="SolrenSun"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="It's A.D. 21XX, after the events of Mega Man X4. The Repliforce was falsely accused of being Mavericks, and the public no longer trusts the Maverick Hunters. A new threat emerges, causing Reploids to behave erratically. Are they cyber-rebels or victims of a larger plot? Help the blue Reploid hero Mega Man X uncover the truth behind the Innocent Impulse incident!"
    LANG="en"
    INFO_MESSAGE="\nFullscreen can be enabled in the game options."
else
    DESC="C'est A.D. 21XX. Se déroule après la guerre de réplication de Mega Man X4. Le Repliforce a été accusé à tort d'être Mavericks pendant l'incident, le public ne fait plus confiance aux Maverick Hunters et demande des changements. Au milieu de tout cela, une nouvelle menace apparaît qui fait que les réploïdes agissent de manière erratique. Ces Reploids sont-ils vraiment des cyber-rebelles ou simplement des victimes d'un complot plus important? Aidez le héros bleu Reploid Mega Man X à découvrir la vérité sur l'incident d'Innocent Impulse!"
    LANG="fr"
