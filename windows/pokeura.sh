...
if [ "$LANG_UI" = "en" ]; then
    DESC="Pokémon Uranium is a free fangame made in RPG Maker XP and Pokémon Essentials. The game takes place in the Tandor region, where the player must collect 8 Gym Badges to enter the Tandor Regional Championship. Along the way, the player must fill the Pokédex with entries for more than 190 different Pokémon species."
    LANG="en"
    INFO_MESSAGE=""
else
