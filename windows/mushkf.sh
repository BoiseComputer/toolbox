...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Mushroom.Kingdom.Fusion.wsquashfs"
URL_TELECHARGEMENT_KEY="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Mushroom.Kingdom.Fusion.wsquashfs.keys"
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="Mushroom.Kingdom.Fusion.wsquashfs"
GAME_FILE_FINAL="Mushroom.Kingdom.Fusion.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Mushroom Kingdom Fusion"
GIT_NAME="mushkf"
DESC=""
DEV="Fusion Fangaming"
PUBLISH="Fusion Fangaming"
GENRE="Plateforme"
LANG="en"
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Mushroom Kingdom Fusion (MKFusion or MKF) is a non-profit, unofficial Mario fan game crossed with many other video game franchises. It features 21 playable characters including Mario, Sonic, Mega Man, Samus Aran, Simon Belmont, Kirby, and more. Each character has their own play style, weapons, and power-ups, across 200+ levels in 9 worlds."
    LANG="en"
    INFO_MESSAGE="\n\nINFO!! Game loading is a bit long, but it works perfectly!"
else
    DESC="Mushroom Kingdom Fusion (MKFusion ou simplement MKF pour faire court) est un jeu de fans Mario non officiel et à but non lucratif croisé avec de nombreuses autres franchises de jeux vidéo. - 21 personnages jouables dont Mario, Sonic, Mega Man, Samus Aran, Simon Belmont, Kirby et plus encore! Chaque personnage est livré avec son propre style de jeu, ses armes et ses power-ups.plus de 200 niveaux répartis sur 9 Mondes."
    LANG="fr"
    INFO_MESSAGE="\n\nINFO!! Chargement du jeu un peu long, mais fonctionne parfaitement!"
fi
