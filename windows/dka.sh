...
GAME_FILE="DK_Advanced.wtgz"
GAME_FILE_FINAL="DK_Advanced.wtgz"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Donkey Kong Advanced"
GIT_NAME="dkadvance"
DESC=""
DEV="Omnitron Studios"
PUBLISH="Omnitron Studios"
GENRE="Arcade"
LANG=""
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="A remake of the classic arcade game. This is not a ROM hack. It is intended to be harder than the original, giving players new levels and new challenges."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Un remake du jeu d'arcade classique. Ce n'est pas un rom hack. Il est censé être plus difficile que l'original donnant aux joueurs de nouveaux niveaux et de nouveaux défis."
    LANG="fr"
    INFO_MESSAGE=""
fi
