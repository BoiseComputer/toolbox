...
if [ "$LANG_UI" = "en" ]; then
    DESC="Rayman Redemption is a reimagining of the original 1995 Rayman game. It adds lots of new content, including new worlds, levels, mini-games, and other collectibles to complete."
    LANG="en"
    INFO_MESSAGE=""
else
