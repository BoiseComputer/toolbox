...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/sonic-triple-trouble.wsquashfs"
URL_TELECHARGEMENT_KEY=""
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="sonic-triple-trouble.wsquashfs"
GAME_FILE_FINAL="sonic-triple-trouble.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Sonic Triple Trouble"
GIT_NAME="sonictt"
DESC=""
DEV="NoahNCopeland"
PUBLISH="NoahNCopeland"
GENRE="Plateforme"
LANG="en"
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Sonic Triple Trouble is a fangame re-imagining of the Game Gear classic Sonic Triple Trouble in the style of the Genesis classics."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Sonic Triple Touble est un fangame ré-imagination du jeu Game Gear Sonic Triple Trouble dans le style de la Genesis classiques.."
    LANG="fr"
    INFO_MESSAGE=""
fi
