...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Super.Smash.Crusade.wsquashfs"
URL_TELECHARGEMENT_KEY="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Super.Smash.Crusade.wsquashfs.keys"
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="Super.Smash.Crusade.wsquashfs"
GAME_FILE_FINAL="Super.Smash.Crusade.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Super Smash Bros Crusade"
GIT_NAME="supersc"
DESC=""
DEV="Falcon8r"
PUBLISH="Phantom7"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Super Smash Bros. Crusade is a free-to-play fangame packed with content across many game genres and gaming culture. Choose fan-favorite Smash characters or one of Crusade's newcomers you won't find anywhere else. There's plenty of content with fan-favorite solo modes like Classic, Break the Targets, and Multi-Man Crusade, plus up to six-player free-for-alls and team matches playable locally or online."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Super Smash Bros. Croisade est un fangame free-to-play qui propose une richesse de contenu couvrant les jeux vidéo de tous les genres et la culture du jeu vidéo.  Faites-le avec notre prise sur certains de vos favoris Smash, ou prenez l'un des nouveaux arrivants de Crusade - dont beaucoup nous promesse vous ne trouverez nulle part ailleurs. Le contenu ne manque pas avec les modes solo préférés des fans Classic, Break the Targets et Multi-Man Crusade, ainsi que jusqu'à six joueurs gratuits et des matchs d'équipe qui peuvent être joués localement ou avec vos amis en ligne."
    LANG="fr"
    INFO_MESSAGE=""
fi
