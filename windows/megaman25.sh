...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Megaman.2.5D.wsquashfs"
URL_TELECHARGEMENT_KEY="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Megaman.2.5D.wsquashfs.keys"
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
...
GAME_NAME="Megaman 2.5D"
GIT_NAME="megaman25"
DESC=""
DEV="Peter Sjöstrand"
PUBLISH="Edgar Cebolledo"
GENRE="Plateforme"
LANG="en"
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Mega Man 2.5D is a platformer fangame for PC by Peter Sjöstrand and Edgar Cebolledo. Three modes are available: solo, co-op multiplayer, and competitive multiplayer. All modes are offline only; solo levels are single-player only and co-op levels are playable with two people."
    LANG="en"
    INFO_MESSAGE="\nRunner -> Wine-TKG"
else
    DESC="Mega Man 2.5D est un fangame de plateforme conçu par Peter Sjöstrand et Edgar Cebolledo pour PC. Trois modes de jeu sont disponibles: solo, multijoueur coopératif et multijoueur compétitif, qui sont tous hors ligne uniquement, les niveaux en solo étant uniquement jouables en solo et les niveaux coopératifs étant uniquement jouables avec deux personnes."
    LANG="fr"
    INFO_MESSAGE="\nRunner -> Wine-TKG"
fi
