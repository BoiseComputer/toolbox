...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/minidoom-2.wsquashfs"
...
GAME_FILE="minidoom-2.wsquashfs"
GAME_FILE_FINAL="minidoom-2.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="MiniDoom 2"
GIT_NAME="minidoom2"
DESC=""
DEV="Calavera Studio"
PUBLISH="Calavera Studio"
GENRE="Action"
LANG="en"
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="What if Doom were a platformer instead of a first-person shooter? The answer is MiniDoom 2, a fan game that pays tribute to the Doom franchise by reimagining it as a retro 2D platformer. It mixes the beloved Doom enemies and classic weapons with old-school 80s/90s games like Contra and Metal Slug, resulting in a fast, pixelated carnage fest with a killer heavy-metal soundtrack. Now with new weapons and Doom Eternal skins!"
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Et si Doom était un jeu de plateforme au lieu d'un jeu de tir à la première personne? La réponse est MiniDoom 2, un jeu de fans qui rend hommage à la franchise Doom en la réimaginant comme un jeu de plateforme rétro 2d. Il prend le casting bien-aimé des ennemis et des armes classiques de DOOM et les mélange avec des jeux 80s et 90s old school comme Contra et Metal Slug résultant en un festival de carnage pixelisé rapide avec une bande sonore de heavy metal tueur. Et maintenant avec de nouvelles armes et peaux de Doom Eternal!"
    LANG="fr"
    INFO_MESSAGE=""
fi
