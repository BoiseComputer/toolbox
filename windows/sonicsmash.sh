...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/SonicSmackdown.wsquashfs"
URL_TELECHARGEMENT_KEY=""
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="SonicSmackdown.wsquashfs"
GAME_FILE_FINAL="SonicSmackdown.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Sonic Smackdown"
GIT_NAME="sonicsmack"
DESC=""
DEV="StreakThunderstorm"
PUBLISH="StreakThunderstorm"
GENRE="Combat"
LANG="en"
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Sonic Smackdown is a free fighting fangame—pit your heroes from the Sonic universe against each other."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Sonic Smackdown est un fangame de combat gratuit, faite combattre vos heros issue de l'univers sonic."
    LANG="fr"
    INFO_MESSAGE=""
fi
