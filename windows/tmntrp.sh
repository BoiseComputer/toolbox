...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/TMNT_Rescue-Palooza.wsquashfs"
...
GAME_FILE="TMNT_Rescue-Palooza.wsquashfs"
GAME_FILE_FINAL="TMNT_Rescue-Palooza.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="TMNT Rescue Palooza"
GIT_NAME="tmntrp"
DESC=""
DEV="Merso X"
PUBLISH="Merso X"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Teenage Mutant Ninja Turtles: Rescue-Palooza is a free beat-'em-up based on TMNT! A tribute and update to classic NES titles, with tons of playable characters for the first time!"
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Teenage Mutant Ninja Turtles: Rescue-Palooza est un jeu de beat-em-up gratuit basé sur le TMNT! Une mise à jour et un hommage aux titres classiques de la NES, avec des tonnes de personnages jouables pour la première fois!"
    LANG="fr"
    INFO_MESSAGE=""
fi
