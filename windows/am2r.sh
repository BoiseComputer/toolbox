...
GAME_FILE_FINAL="am2r.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
...
if [ "$LANG_UI" = "en" ]; then
    DESC="AM2R (Another Metroid 2 Remake) is an action-adventure game released in 2016 for Windows. It is an unofficial remake of the 1991 Game Boy game Metroid II: Return of Samus, in the style of Metroid: Zero Mission (2004). As in the original, players control bounty hunter Samus Aran, whose mission is to eradicate the Metroids on their home planet SR-388."
    LANG="en"
    INFO_MESSAGE=""
else
