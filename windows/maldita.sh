...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/maldita_castilla.wsquashfs"
URL_TELECHARGEMENT_KEY=""
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="maldita_castilla.wsquashfs"
GAME_FILE_FINAL="maldita_castilla.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Maldita Castilla"
GIT_NAME="maldita"
DESC=""
DEV="Locomalito"
PUBLISH="Locomalito"
...
if [ "$LANG_UI" = "en" ]; then
    DESC="A young witch wept for her lost love when a demon heard her lament. Seduced by its promises, she turned her tears into a magic key. With that key, demons opened the gates of hell upon the Kingdom of Castile. Overwhelmed, King Alfonso VI of León called his most loyal knights. Travel as the brave Don Ramiro through the cursed lands of Tolomera to end this nightmare—for the love of God and for Castile!"
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Une jeune sorcière pleurait pour son amour déchu quand un démon a entendu sa complainte. Séduite par les promesses de la bête, elle transforma ses larmes en une clé magique. Et il en fut ainsi, avec cette clef, que les démons ouvrirent les portes de l'enfer sur le Royaume de Castille. Accablé par la situation, le roi Alphonse VI de Léon a convoqué ses chevaliers les plus fidèles. Voyagez comme le brave Don Ramiro à travers les terres damnées de Tolomera pour mettre fin à ce cauchemar. Pour l'amour de Dieu et pour la Castille!"
    LANG="fr"
    INFO_MESSAGE=""
fi
