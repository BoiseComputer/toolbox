...
##############################################################################################################
# VARIABLE DU JEU
URL_TELECHARGEMENT="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Power.Bomberman.wsquashfs"
URL_TELECHARGEMENT_KEY="https://github.com/foclabroc/toolbox/releases/download/Fichiers/Power.Bomberman.wsquashfs.keys"
CHEMIN_SCRIPT=""
FICHIER_ZIP=""
PORTS_DIR="/userdata/roms/ports"
WIN_DIR="/userdata/roms/windows"
GAME_FILE="Power.Bomberman.wsquashfs"
GAME_FILE_FINAL="Power.Bomberman.wsquashfs"
INFO_MESSAGE=""
##############################################################################################################
##############################################################################################################
# VARIABLES GAMELIST
IMAGE_BASE_URL="https://raw.githubusercontent.com/foclabroc/toolbox/refs/heads/main/_images"
GAME_NAME="Power Bomberman"
GIT_NAME="powerb"
DESC=""
DEV="Bomberman Community"
PUBLISH="Bomberman Community"
GENRE="Action"
LANG=""
REGION="eu"
########################################
...
if [ "$LANG_UI" = "en" ]; then
    DESC="Power Bomberman keeps the essence of the classic game with fast, strategic, action-packed gameplay. Players place bombs, destroy blocks, collect power-ups, and battle opponents on maps that demand skill and strategy. It also introduces new mechanics, extra characters, and customization options to refresh the experience without losing its original charm."
    LANG="en"
    INFO_MESSAGE=""
else
    DESC="Power Bomberman conserve l'essence de ce jeu classique connu pour son gameplay rapide, stratégique et plein d'action. Les joueurs peuvent placer des bombes, détruire des blocs, collecter des bonus et s'affronter pour vaincre leurs adversaires sur des cartes qui exigent un haut niveau d'habileté et de stratégie. Cependant, ce jeu ne se contente pas de reproduire ce qui a fait le succès de Bomberman. Il introduit également quelques innovations intéressantes, telles que de nouveaux mécanismes, des personnages supplémentaires et des options de personnalisation, afin de revitaliser l'expérience sans perdre son charme d'origine."
    LANG="fr"
    INFO_MESSAGE=""
fi
